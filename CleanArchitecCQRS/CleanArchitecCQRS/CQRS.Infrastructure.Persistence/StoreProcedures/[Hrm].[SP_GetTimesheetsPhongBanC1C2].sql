...
/****** Object:  StoredProcedure [Hrm].[SP_GetTimesheetsPhongBanC1C2]    Script Date: 11/7/2022 10:23:47 AM ******/
SET ANSI_NULLS ON
GO
...
/*==============================================================================================
   ...
   -----------------------------------------------------------------------------------------
   Vinh Huynh		2022.11.07		2022.11.10				Get danh sách timesheet cho TPB
============================================================================================= */

CREATE procedure [Hrm].[SP_GetTimesheetsPhongBanC1C2]
	@pageNumber int,
	@pageSize int,
	@thoiGian datetime,
...
begin
	...
	right join Esuhai.DanhMucs dm
		on dm.[Id] = nv.[TrangThaiId]
	where 
				(nv.XetDuyetCap1 = @nhanvienId or nv.XetDuyetCap2 = @nhanvienId)
			and
				(
					(nv.HoTENDemVN + ' ' +nv.TenVN) like N'%' +@keyword +'%' 
				or 
