...
/****** Object:  StoredProcedure [Hrm].[SP_GetTimesheetsPhongBanV2C1C2]    Script Date: 11/14/2022 10:48:12 AM ******/
SET ANSI_NULLS ON
GO
...
/*==============================================================================================
   ...
   -----------------------------------------------------------------------------------------
   Vinh Huynh		2022.11.07		2022.11.21				Get danh sách timesheet cho TPB version 2
============================================================================================= */


CREATE procedure [Hrm].[SP_GetTimesheetsPhongBanV2C1C2]
	@pageNumber int,
	@pageSize int,
	@thoiGian datetime,
