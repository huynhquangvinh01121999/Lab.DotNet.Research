...
namespace EsuhaiHRM.Application.Features.Timesheets.Commands.CheckIn_Out
{
    ...
    public class CheckOutCommandHandler : IRequestHandler<CheckOutCommand, Response<string>>
    {
        ...
        public CheckOutCommandHandler(INhanVienRepositoryAsync nhanVienRepositoryAsync, ITimesheetRepositoryAsync timesheetRepositoryAsync)
        {
            _nhanVienRepositoryAsync = nhanVienRepositoryAsync;
            _timesheetRepositoryAsync = timesheetRepositoryAsync;
        }

        public async Task<Response<string>> Handle(CheckOutCommand request, CancellationToken cancellationToken)
        {
            try
            {
