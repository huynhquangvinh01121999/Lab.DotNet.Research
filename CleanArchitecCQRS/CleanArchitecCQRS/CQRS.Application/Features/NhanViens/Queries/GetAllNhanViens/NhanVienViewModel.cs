...
{
    public class NhanViensViewModel
    {
        ...
        public string CMNDNoiCapTenTinhVN { get; set; }
        public string PassportNoiCapTenTinhVN { get; set; }
        ...
        public string NhanVienXetDuyetCap1HoTenVN { get; set; }
        public string NhanVienXetDuyetCap2HoTenVN { get; set; }
    }
}
